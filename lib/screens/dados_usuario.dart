...
class _DadosUsuarioState extends State<DadosUsuario> {
  ...
  void getCep() async {
    ...
    setState(() {
      ...
      _estadoSelecionado = respostaCep.uf;
    });
  }
  ...
  void _onPressed() {
    ...
    firestoreInstance.collection("users").doc(firebaseUser.uid).set({
      ...
      "ponto_geografico": _pontoGeograficoController.text,
      "telefone": _telefoneController.text,
      "mes_aniversario": _mesSelecionado,
